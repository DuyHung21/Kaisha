...
@NamedQueries({
    ...
    , @NamedQuery(name = "Customers.findByTotalMoney", query = "SELECT c FROM Customers c WHERE c.totalMoney = :totalMoney")})
...
//    @NotNull
    ...
    public String toString() {
        return "com.softech.shop.model.Customers[ customerId=" + customerId + " ]";
    }
