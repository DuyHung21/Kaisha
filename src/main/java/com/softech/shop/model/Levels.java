...
@NamedQueries({
    ...
    , @NamedQuery(name = "Levels.findByLevelId", query = "SELECT l FROM Levels l WHERE l.levelId = :levelId")
...
//    @NotNull
    ...
    public String toString() {
        return "com.softech.shop.model.Levels[ levelId=" + levelId + " ]";
    }
